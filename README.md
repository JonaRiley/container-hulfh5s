...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hulfh5s.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hulfh5s.containers.anotherwebservice.com/
...
```
git clone git@github.com:JonaRiley/container-hulfh5s.git
cd container-hulfh5s
```
...
```
docker attach container-hulfh5s
```
